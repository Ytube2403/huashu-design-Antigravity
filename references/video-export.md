...
```bash
NODE_PATH=$(npm root -g) node /path/to/huashu-design-Antigravity/scripts/render-video.js <html文件>
```
...
```bash
bash /path/to/huashu-design-Antigravity/scripts/convert-formats.sh <input.mp4> [gif_width] [--minterpolate]
```
